                    ...
                    <div class="booking-details visit">
                        <div class="columns">
                            <div class="left">
                                ...
                                <h2 class="section-title mb-3" >Vip Tours </h2>
                            ...
                            <div class="middle">
                                ...
                                <div class="row">
                                     <div class="col-md-6 mb-3">
                                        <div class="form-element">
                                            ...
                                            <input type="text" value="Organization Name" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="form-element">
                                            <label class="control-label">Other requests or special interests: </label>
                                            <textarea type="text" class="form-control">NO</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="custom-checkbox">
                                    ...
                                    <label class="lbl">I understand that submitting this form doesn't confirm my VIP booking.<label>
