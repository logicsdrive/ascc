            ...
            <div id="smooth-wrapper">
                <div id="smooth-content">
                    <div class="contentWrapper">
                        <div class="camera-mobile-view" data-image="images/home_banner/mobile-background.png">
                            <h2 class="title">explore Our museums</h2>
                            <div class="container">
                                <div class="swiper">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="object-item">
                                                <img class="tree" src="images/home_banner/banner_block1_tree.png" alt="" loading="lazy">
                                                <div class="base">
                                                    <img src="images/home_banner/mobile/banner_block1.png" alt="" loading="lazy">
                                                    <img class="animated_object" src="images/home_banner/banner_block1_vector.gif" alt="" loading="lazy">
                                                    <div class="text">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="object-item">
                                                <img class="tree" src="images/home_banner/banner_block2_tree.png" alt="" loading="lazy">
                                                <div class="base">
                                                    <img src="images/home_banner/mobile/banner_block2.png" alt="" loading="lazy">
                                                    <img class="animated_object" src="images/home_banner/banner_block2_vector.gif" alt="" loading="lazy">
                                                    <div class="text">
                                                        <h5>Space</h5>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="object-item">
                                                <img class="tree" src="images/home_banner/banner_block4_tree.png" alt="" loading="lazy">
                                                <div class="base">
                                                    <img src="images/home_banner/mobile/banner_block2.png" alt="" loading="lazy">
                                                    <img class="animated_object" src="images/home_banner/banner_block3_vector.gif" alt="" loading="lazy">
                                                    <div class="text">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="object-item">
                                                ...
                                                <div class="base">
                                                    <img src="images/home_banner/mobile/banner_block2.png" alt="" loading="lazy">
                                                    <img class="animated_object" src="images/home_banner/banner_block4_vector.gif" alt="" loading="lazy">
                                                    <div class="text">
                                                        <h5>Theater</h5>
                                                        <p>he study of space & the universe has always evoked mystery & inspiration. The Centre’s Space exhibit gives audiences an unprecedented opportunity..</p>
                                                    </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="object-item">
                                                <img class="tree" src="images/home_banner/banner_block5_tree.png" alt="" loading="lazy">
                                                <div class="base">
                                                    <img src="images/home_banner/mobile/banner_block2.png" alt="" loading="lazy">
                                                    <img class="animated_object" src="images/home_banner/banner_block5_vector.gif" alt="" loading="lazy">
                                                    <div class="text">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="object-item">
                                                <img class="tree" src="images/home_banner/banner_block6_tree.png" alt="" loading="lazy">
                                                <div class="base">
                                                    <img src="images/home_banner/mobile/banner_block2.png" alt="" loading="lazy">
                                                    <img class="animated_object" src="images/home_banner/banner_block6_vector.gif" alt="" loading="lazy">
                                                    <div class="text">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="object-item">
                                                <img class="tree" src="images/home_banner/banner_block7_tree.png" alt="" loading="lazy">
                                                <div class="base">
                                                    <img src="images/home_banner/mobile/banner_block2.png" alt="" loading="lazy">
                                                    <img class="animated_object" src="images/home_banner/banner_block7_vector.gif" alt="" loading="lazy">
                                                    <div class="text">
                                                        <h5>Ecosystems</h5>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="object-item">
                                                <img class="tree" src="images/home_banner/banner_block8_tree.png" alt="" loading="lazy">
                                                <div class="base">
                                                    <img src="images/home_banner/mobile/banner_block2.png" alt="" loading="lazy">
                                                    <img class="animated_object" src="images/home_banner/banner_block8_vector.gif" alt="" loading="lazy">
                                                    <div class="text">
                            ...
                            <div class="group">
                                <div class="set set4" id="step4">
                                    <a href="our-echosystem.php" data-custom-cursor="Explore More" class="object object1">
                                        <img src="images/home_banner/banner_block7.png" alt="" loading="lazy">
                                        <img class="tree" src="images/home_banner/banner_block7_tree.png" alt="" loading="lazy">
                                        <img class="animated_object static" src="images/home_banner/banner_block7_vector.png" alt="" loading="lazy">
                                        <img class="animated_object gif" src="images/home_banner/banner_block7_vector.gif" alt="" loading="lazy">
                                        <div class="text">
                                            <h5>Ecosystems</h5>
                                            <p>Travel back in time to gain a unique insight into the natural world – both past and present, understand the importance of ecosystems.</p>
                                        </div>
                                    ...
                                    <a href="our-earth.php" data-custom-cursor="Explore More" class="object object2">
                                        <img src="images/home_banner/banner_block8.png" alt="" loading="lazy">
                                        <img class="tree" src="images/home_banner/banner_block8_tree.png" alt="" loading="lazy">   
                                        <img class="animated_object static" src="images/home_banner/banner_block8_vector.png" alt="" loading="lazy">
                                        <img class="animated_object gif" src="images/home_banner/banner_block8_vector.gif" alt="" loading="lazy">
                                        <div class="text">
                                            <h5>Natural History – Our Earth</h5>
                                            <p>Enter the world of the dinosaurs! See the amazing reptiles and mammals that lived on Earth up to 65 million years ago.</p>
                                        </div>
                                ...
                                <div class="set set3" id="step3">
                                    <a href="trans-n-robots.php" data-custom-cursor="Explore More" class="object object1">
                                        <img src="images/home_banner/banner_block5.png" alt="" loading="lazy">
                                        <img class="tree" src="images/home_banner/banner_block5_tree.png" alt="" loading="lazy">
                                        <img class="animated_object static" src="images/home_banner/banner_block5_vector.png" alt="" loading="lazy">
                                        <img class="animated_object gif" src="images/home_banner/banner_block5_vector.gif" alt="" loading="lazy">
                                        <div class="text">
                                            <h5>Transportation & Robots</h5>
                                            <p>Through the centuries the evolution of transport has taken us from elementary hot air balloons to jet engines, horse-drawn carriages to cars and small boats to oil tankers.</p>
                                        </div>
                                    ...
                                    <a href="human-body.php" data-custom-cursor="Explore More" class="object object2">
                                        <img src="images/home_banner/banner_block6.png" alt="" loading="lazy">
                                        <img class="tree" src="images/home_banner/banner_block6_tree.png" alt="" loading="lazy">
                                        <img class="animated_object static" src="images/home_banner/banner_block6_vector.png" alt="" loading="lazy">
                                        <img class="animated_object gif" src="images/home_banner/banner_block6_vector.gif" alt="" loading="lazy">
                                        <div class="text">
                                            <h5>Science & Technology – Human Body</h5>
                                            <p>There is nothing more exciting and intricate than the workings of the human body and mind. Its secrets are revealed as we journey through.</p>
                                        </div>
                                ...
                                <div class="set set2" id="step2">
                                    <a href="#" data-custom-cursor="Explore More" class="object object1">
                                        <img src="images/home_banner/banner_block3.png" alt="" loading="lazy">
                                        <img class="animated_object static" src="images/home_banner/banner_block3_vector.png" alt="" loading="lazy">
                                        <img class="animated_object gif" src="images/home_banner/banner_block3_vector.gif" alt="" loading="lazy">
                                        <div class="text">
                                            <h5>guest relation</h5>
                                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                                        </div>
                                    ...
                                    <a href="theatre.php" data-custom-cursor="Explore More" class="object object2">
                                        <img src="images/home_banner/banner_block4.png" alt="" loading="lazy">
                                        <img class="tree" src="images/home_banner/banner_block4_tree.png" alt="" loading="lazy">
                                        <img class="animated_object static" src="images/home_banner/banner_block4_vector.png" alt="" loading="lazy">
                                        <img class="animated_object gif" src="images/home_banner/banner_block4_vector.gif" alt="" loading="lazy">
                                        <div class="text">
                                            <h5>Theater</h5>
                                            <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                                        </div>
                                ...
                                <div class="set set1" id="step1">
                                    <a href="arabic-science.php" data-custom-cursor="Explore More" class="object object1">
                                        <img class="tree" src="images/home_banner/banner_block1_tree.png" alt="" loading="lazy">
                                        <img src="images/home_banner/banner_block1.png" alt="" loading="lazy">
                                        <img class="animated_object" src="images/home_banner/banner_block1_vector.gif" alt="" loading="lazy">
                                        <div class="text">
                                            <h5>Arabic Islamic Science</h5>
                                            <p>With its focus on the Golden Age of Islam and the innumerable scientific, cultural and artistic contributions of Muslims and Arabs to modern day science</p>
                                    ...
                                    <a href="our-space.php" data-custom-cursor="Explore More" class="object object2">
                                        <img class="tree" src="images/home_banner/banner_block2_tree.png" alt="" loading="lazy">
                                        <img src="images/home_banner/banner_block2.png" alt="" loading="lazy">
                                        <img class="animated_object" src="images/home_banner/banner_block2_vector.gif" alt=""  loading="lazy">
                                        <div class="text">
                                            <h5>Space</h5>
                            ...
                            <div class="container">
                                <div class="grid">
                                    <div class="item position-relative">
                                        <figure class="image"><img src="images/our-mission-image.jpg" alt="" loading="lazy"></figure>
                                        <div class="inner">
                                            <div class="title-holder">
                                                <h4 class="section-title">What's on</h4>
                                                <svg class="icon" width="46" height="45" viewBox="0 0 46 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <defs>
                                                        <clipPath transform="translate(40 40)"><rect x="1" y="1" width="43.8182" height="43" rx="21.5"/></clipPath>
                                                    </defs>
                                                </svg>
                                            </div>
                                    ...
                                    <div class="item position-relative">
                                        <figure class="image"><img src="images/our-vision-image.jpg" alt="" loading="lazy"></figure>
                                        <div class="inner">
                                            <div class="title-holder">
                        ...
                        <div class="gallery">
                            <div class="container">
                                <div class="title-area">
                                    <h2 class="section-title" data-animate="fade-right">Gallery</h2>
                        ...
                        <div class="contact">
                                    ...
                                    <div class="columns">
                                        ...
                                        <aside class="address">
                                            ...
                                            <div class="item">
                                                ...
                                                <a href="tel:+96522222211">+965 22222211</a>
                                            </div>
                                            <div class="item">
                                                <label>Address</label>
                            ...
                            <figure class="block2">
                                <img src="images/contact_map.jpg" alt=""  loading="lazy">
                            </figure>
                        </div>
                    </div>
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function () {
                            document.querySelectorAll(".camera-mobile-view").forEach(function (el) {
