                    ...
                    <div class="booking-confirmation">
                        <div class="container">
                            <div class="message success" data-animate="fade-up">
                                ...
                                <h2 class="section-title" data-animate="fade-up">We Are Sorry</h2>
                                <span data-animate="fade-up">Your Order has Been <em class="text-danger">Cancelled</em></span>
                            </div>
                            <div class="info" data-animate="fade-up">
                                <div class="item">
                                    <h5>Order Number</h5>
                                    <span>4584</span>
                                </div>
