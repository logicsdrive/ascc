            ...
            <div id="smooth-content">
                ...
                <main class="main-content">
                    <div class="booking-confirmation request">
                        <div class="container">
                            <div class="message success mb-4" data-animate="fade-up">
                                ...
                                <p data-animate="fade-up" class="mb-2">Thank you for requesting to book a School Tour to the Shaikh Abdulla Al 
                                Salem Cultural Centre, we will review your request and confirm
                                your visit soon. </p>
                            </div>
