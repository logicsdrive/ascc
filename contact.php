            ...
            <div id="smooth-content">
                ...
                <main class="main-content">
                    <div class="contact">
                        <div class="container">
                            <div class="block1">
                                <h2 class="section-title mb-2" data-animate="fade-up">We're Here to Help</h2>
                                <p class="tagline" data-animate="fade-up">We'd love to hear from you! Get in touch with us for any questions, suggestions, or feedback</p>
                                <div class="columns">
                                    <form class="form">
