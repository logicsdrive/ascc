...
<html lang="en">
    <head>
        ...
        <?php include 'images/home/svg_assets.php';  ?>
    </head>
    <body class="home-page">
        <div class="enter-the-center">
            ...
            <button class="btn btn-primary center-button" onclick="ascc_app.scrollTo('camera-view');">Enter The Centre</button>
        </div>
        <main class="main-content">
            ...
            <div class="home-block1">
                <div class="container">
                    <div class="grid">
                        <div class="item">
                            <figure class="image"><img src="images/whatson-image.jpg" alt="" /></figure>
                            <div class="inner">
                        ...
                        <div class="item">
                            <figure class="image"><img src="images/about-image.jpg" alt="" /></figure>
                            <div class="inner">
                                <div class="title-holder">
