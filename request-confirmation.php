                    ...
                    <div class="booking-confirmation request">
                        <div class="container">
                            <div class="message success" data-animate="fade-up">
                                ...
                                <h2 class="section-title" data-animate="fade-up">Request submitted successfully</h2>
                                <p data-animate="fade-up">Thank you for choosing Sheikh Abdullah Al Salem Cultural Center (ASCC Kindly note that this reservation is not approved yet and under consideration Our team will contact you for proceeding </p>
                            </div>
                            <div class="info">
                                <div class="item" data-animate="fade-up">
                                    <h5>reference Number</h5>
                                    <span>RS-2093-397</span>
                                </div>
                                <div class="item" data-animate="fade-up">
